        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('unidades-saude.update', $unidade) }}" class="space-y-4">
                        @csrf
                        @method('PUT')

                        <div>
                            <label class="block text-sm mb-1">Nome *</label>
                            <input name="nome" value="{{ old('nome', $unidade->nome) }}"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input name="provincia" value="{{ old('provincia', $unidade->provincia) }}"
                                       class="w-full rounded border-gray-300 dark:border-gray-700 dark:bg-gray-900"
                                       required>
                            </div>
                            <div>
                                <label class="block text-sm mb-1">Município *</label>
                                <input name="municipio" value="{{ old('municipio', $unidade->municipio) }}"
                                       class="w-full rounded border-gray-300 dark:border-gray-700 dark:bg-gray-900"
                                       required>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input name="comuna" value="{{ old('comuna', $unidade->comuna) }}"
                                       class="w-full rounded border-gray-300 dark:border-gray-700 dark:bg-gray-900">
                            </div>
                            <div>
                                <label class="block text-sm mb-1">Bairro</label>
                                <input name="bairro" value="{{ old('bairro', $unidade->bairro) }}"
                                       class="w-full rounded border-gray-300 dark:border-gray-700 dark:bg-gray-900">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input name="telefone" value="{{ old('telefone', $unidade->telefone) }}"
                                   class="w-full rounded border-gray-300 dark:border-gray-700 dark:bg-gray-900">
                        </div>
                    ...
                    <form class="mt-4" method="POST" action="{{ route('unidades-saude.destroy', $unidade) }}"
